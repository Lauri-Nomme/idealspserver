...
Four bugs were identified by inspecting the 2026.1 SDK classes.
...
From `DaemonCodeAnalyzerImpl`, `HighlightingSessionImpl`, and `ProgressableTextEditorHighlightingPass`:
